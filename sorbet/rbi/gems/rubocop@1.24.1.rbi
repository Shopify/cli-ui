...
class RuboCop::Config
  ...
  def each_key(*args, **_arg1_arg1, &block); end
  ...
  def internal?; end
  def key?(*args, **_arg1_arg1, &block); end
  def keys(*args, **_arg1_arg1, &block); end
  def loaded_features; end
  def loaded_path; end
  def make_excludes_absolute; end
  def map(*args, **_arg1_arg1, &block); end
  def merge(*args, **_arg1_arg1, &block); end
  ...
  def target_ruby_version(*args, **_arg1_arg1, &block); end
  def to_h(*args, **_arg1_arg1, &block); end
  def to_hash(*args, **_arg1_arg1, &block); end
  def to_s; end
  def transform_values(*args, **_arg1_arg1, &block); end
  def validate(*args, **_arg1_arg1, &block); end
...
class RuboCop::ConfigValidator
  ...
  def for_all_cops(*args, **_arg1_arg1, &block); end
  def smart_loaded_path(*args, **_arg1_arg1, &block); end
